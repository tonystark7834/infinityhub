...
// Fetch movies (Uses Bearer Token)
    ...
    for (const cat of categories) {
        ...
        row.innerHTML = `
            <div class="carousel-nav">
                ...
                <div>
                    <button class="nav-btn" onclick="scrollLeft('${cat.name.replace(/\s+/g, "")}')">
                        <i class="fas fa-chevron-left"></i>
                    </button>
                    <button class="nav-btn" onclick="scrollRight('${cat.name.replace(/\s+/g, "")}')">
                ...
                <div class="overlay">
                    ...
                    <button onclick="toggleWatchlist(${movie.id}, '${movie.title.replace(/'/g, "\\'")}')">
                        <i class="fas fa-plus"></i> ${
                            watchlist.includes(movie.id) ? "Remove" : "Add"
                        }
                    </button>
                </div>
            `;
